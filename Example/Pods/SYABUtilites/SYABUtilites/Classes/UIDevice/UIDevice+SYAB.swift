...
public extension UIDevice {
    ...
    static public func syab_phoneType() -> String {
        var phoneType = _currentModel()
        phoneType = phoneType.replacingOccurrences(of: " ", with: "")
        return phoneType
    }
    
    static public func syab_idfaString() -> String {
        let idfa = ASIdentifierManager.shared().advertisingIdentifier.uuidString
        return idfa
    }
    
    static public func syab_idfvString() -> String {
    ...
    static public func syab_userAgent() -> String {
    ...
    static public func syab_carrier() -> String {
    ...
    static public func syab_ssid() -> String {
    ...
    static public func syab_bssid() -> String {
    ...
    // 每次调用生成不同UUID
    static public func syab_uuid() -> String {
