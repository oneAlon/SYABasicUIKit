...
public extension UIImage {
    ...
    public convenience init?(syab_color color: UIColor, size: CGSize = CGSize(width: 1.0, height: 1.0)) {
    ...
    public func syab_roundImage(byRoundingCorners: UIRectCorner = UIRectCorner.allCorners, cornerRadi: CGFloat) -> UIImage? {
        return syab_roundImage(byRoundingCorners: byRoundingCorners, cornerRadii: CGSize(width: cornerRadi, height: cornerRadi))
    }
    
    public func syab_roundImage(byRoundingCorners: UIRectCorner = UIRectCorner.allCorners, cornerRadii: CGSize) -> UIImage? {
    ...
    public func syab_scaleTo(size targetSize: CGSize) -> UIImage? {
    ...
    public func syab_scaleTo(fitSize targetSize: CGSize, scaleIfSmaller: Bool = false) -> UIImage? {
        let srcSize = self.size
        if __CGSizeEqualToSize(srcSize, targetSize) {
            return self
        }
        ...
        return self.syab_scaleTo(size: dstSize)
    }
